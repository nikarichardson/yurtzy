...
def create_app(test_config=None):
	...
	def add_campsite():
		...
		yurts_and_cabins = body.get('yurts_and_cabins')  
		bathrooms = body.get('bathrooms') 
		parking = body.get('parking')  
		ada_access = body.get('ada_access') 
		campfires = body.get('campfires') 
		showers = body.get('showers') 
		wifi = body.get('wifi')  
		trash_bins = body.get('trash_bins') 
		picnic_area = body.get('picnic_area') 
		pets_allowed = body.get('pets_allowed') 
		potable_water = body.get('potable_water') 
		rv_parks = body.get('rv_parks') 
		hiking = body.get('hiking') 
		camping = body.get('camping') 
		biking = body.get('biking') 
		kayaking = body.get('kayaking') 
		swimming = body.get('swimming')  
		cooking_grills = body.get('cooking_grills')  
